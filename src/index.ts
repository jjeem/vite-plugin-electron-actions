...
const HANDLERS_MAP_ID = "vite-plugin-electron-actions:handlers-map";
const RESOLVED_HANDLERS_MAP_ID = "\0vite-plugin-electron-actions-handlers-map";
...
// vite-plugin-electron-actions:non-exported-actions: is only used internally by the main
